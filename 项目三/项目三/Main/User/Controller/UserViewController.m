...
- (void)btnAction{
    ...
    UIAlertController *action = [UIAlertController alertControllerWithTitle:@"设置" message:nil preferredStyle:UIAlertControllerStyleActionSheet];
    UIAlertAction *cancel = [UIAlertAction actionWithTitle:@"取消" style:UIAlertActionStyleCancel handler:nil];
    
    UIAlertAction *photo = [UIAlertAction actionWithTitle:@"修改头像" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
    ...
    UIAlertAction *target = [UIAlertAction actionWithTitle:@"修改目标" style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        NSLog(@"修改目标");
    }];
    
    [action addAction:cancel];
    [action addAction:photo];
    [action addAction:target];
}
